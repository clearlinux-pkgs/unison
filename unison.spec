...
Version  : 2.53.4
Release  : 9
URL      : https://github.com/bcpierce00/unison/archive/v2.53.4/unison-2.53.4.tar.gz
Source0  : https://github.com/bcpierce00/unison/archive/v2.53.4/unison-2.53.4.tar.gz
...
%prep
%setup -q -n unison-2.53.4
cd %{_builddir}/unison-2.53.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708988753
