...
Source0  : https://github.com/bcpierce00/unison/archive/v2.51.4/unison-2.51.4.tar.gz
...
%prep
%setup -q -n unison-2.51.4
cd %{_builddir}/unison-2.51.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633195305
...
cp %{_builddir}/unison-2.51.4/LICENSE %{buildroot}/usr/share/package-licenses/unison/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/unison-2.51.4/src/COPYING %{buildroot}/usr/share/package-licenses/unison/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
